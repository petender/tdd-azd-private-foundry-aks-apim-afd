...
```bash
cd generated-scenarios/private-foundry-aks-apim-afd
...
| Azure OpenAI             | gpt-4o model backend (scenario-owned)     |
...
| `infra/modules/`              | Modular Bicep (networking, AKS, APIM, AFD, Foundry, OpenAI, ...) |
| `k8s/`                        | Kubernetes manifests (deployment, service, serviceaccount) |
| `src/FoundryChat.Web/`        | .NET 10 Razor Pages chat web app     |
